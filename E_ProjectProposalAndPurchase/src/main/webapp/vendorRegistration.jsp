...
<body>
	...
	<form action="vendorregister" method="post" onSubmit="return validate()">
		<div class="heading">
			<h1>
			...
			<table>
				...
				<tr>
					...
					<td><input type="tel" placeholder="Enter Contact Number"
						name="contactNumber" id="contactNumber" pattern="[1-9]{3}[0-9]{3}[0-9]{4}"
						title="Enter in this form 123-345-1234"></td>
				</tr>
				<tr>
				...
				<tr>
					<td><input type="submit" class="button" value="Register"
						required></td>
					<td><a href="vendor.jsp" class="row">Back</a></td>
				</tr>
			</table>
		</div>
	</form>
